...
class CategoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  Column(
      children: [
         Expanded(child: 
          BlocBuilder<AllCategoriesFetchBloc, AllCategoriesFetchState>(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Positioned(
                            ...
                            right: 0,
                            child: 
                          item.image==null? Image.asset(AssetName.categoryDemoPng, fit: BoxFit.cover,): Image.network(item.image!, fit: BoxFit.cover,errorBuilder: (context, error, stackTrace) {
                        return Image.asset(AssetName.categoryDemoPng, fit: BoxFit.cover,);
                      },),
                          ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: BackdropFilter(filter: ImageFilter.blur(sigmaX: 15, sigmaY: 15), child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(item.name, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 18),),
                              ),),
                            ),
                          )
                        ],
